...
public class VideoRestController {
	...
	@GetMapping("/{videoId}/like/{userId}")
	@ApiOperation("비디오의 찜 여부 반환")
	public ResponseEntity<?> getLikedVideos(@PathVariable String videoId, @PathVariable String userId){
		boolean isLiked = videoService.isLikedVideo(videoId, userId);
